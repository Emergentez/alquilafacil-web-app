...
<template>
  ...
  <button @click="openUploadWidget" class="flex flex-col p-10 shadow-2xl hover:cursor-pointer rounded-xl bg-(--background-card-color) hover:scale-105 transition-transform">
